...
class MyLocation {
    ...
    companion object{
        ...
        ): Boolean { //I use LocationResult callback class to pass location value from MyLocation to user code.
...
//don't start listeners if no provider is enabled
        ...
        class GetLastLocation : TimerTask() {
            @SuppressLint("MissingPermission")
            override fun run() { //Context context = getClass().getgetApplicationContext();
